    ...
    ui(new Ui::UserManageSetForm)
{
    ...
    ui->tableWidget->setColumnWidth(0, 10 + _w_cum);
    ui->tableWidget->setColumnWidth(1, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(2, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(3, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(4, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(5, 20 + _w_cum);
    ui->tableWidget->setColumnWidth(6, 20 + _w_cum);
    ui->tableWidget->setColumnWidth(7, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(8, 40 + _w_cum);
    ui->tableWidget->setColumnWidth(9, 200 + _w_cum);
    ui->tableWidget->setColumnWidth(10, 140 + _w_cum);
