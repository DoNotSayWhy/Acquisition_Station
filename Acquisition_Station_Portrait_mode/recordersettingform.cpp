...
void applyPortraitRecorderLayout(Ui::RecorderSettingForm *ui, QWidget *page)
{
    const int width = page->width();
    const QFont labelFont("Sans Serif", 15, QFont::DemiBold);
    const QFont controlFont("Sans Serif", 15);

    ui->checkBox->setGeometry(34, 28, 150, 48);
    ui->checkBox_3->setGeometry(194, 28, 120, 48);
    ui->checkBox->setFont(controlFont);
    ui->checkBox_3->setFont(controlFont);

    ui->label->setGeometry(120, 150, 180, 56);
    ui->lineEditUserNo->setGeometry(315, 150, width - 435, 56);
    ui->label_2->setGeometry(120, 232, 180, 56);
    ui->lineEditDeviceNo->setGeometry(315, 232, width - 435, 56);
    ui->label->setFont(labelFont);
    ui->label_2->setFont(labelFont);
    ui->lineEditUserNo->setFont(controlFont);
    ui->lineEditDeviceNo->setFont(controlFont);

    ui->pushButtonRead->setGeometry(315, 336, 180, 62);
    ui->pushButtonModify->setGeometry(520, 336, 250, 62);
    ui->pushButtonRead->setFont(QFont("Sans Serif", 15, QFont::DemiBold));
    ui->pushButtonModify->setFont(QFont("Sans Serif", 15, QFont::DemiBold));
}
...
{
    ui->setupUi(this);
    applyPortraitRecorderLayout(ui, this);
}
